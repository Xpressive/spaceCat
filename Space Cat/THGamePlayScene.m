...
-(void) createDebrisAtPosition:(CGPoint)position {
    ...
    for (int i = 0; i < numberOfPieces; i++) {
        ...
        debris.physicsBody.collisionBitMask = THCollisionCategoryGround | THCollisionCategoryDebris | THCollisionCategoryProjectile;
        debris.name = @"Debris";
        debris.physicsBody.velocity = CGVectorMake([THUtil randomWithMin:-150 max:150], [THUtil randomWithMin:150 max:350]);
        [debris runAction:[SKAction waitForDuration:2] completion:^{
